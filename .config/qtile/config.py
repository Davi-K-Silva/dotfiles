# based on https://github.com/jorgeloopzz/dotfiles
...
layouts = [
    layout.MonadTall(border_focus="#eff108",
                     border_normal="#31748f", border_width=1, margin=8),
    layout.Max(),
    layout.Bsp(border_focus="#eff108", border_normal="#31748f",
               border_width=1, margin=8),
    layout.MonadWide(border_focus="#eff108",
                     border_normal="#31748f", border_width=1, margin=8),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Image(
                    filename="~/.config/qtile/Archlinux-icon-crystal-64.svg",
                    scale="False"
                ),
                widget.Sep(
                    linewidth=0,
